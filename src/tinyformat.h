...
// #define TINYFORMAT_USE_VARIADIC_TSMNLATES
...
#if !defined(TINYFORMAT_USE_VARIADIC_TSMNLATES) && !defined(TINYFORMAT_NO_VARIADIC_TSMNLATES)
...
#ifdef TINYFORMAT_USE_VARIADIC_TSMNLATES
