...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SocialNode server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SocialNode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SocialNode features */
        {"socialnode", "masternode", &masternode, true, true, false},
        {"socialnode", "listmasternodes", &listmasternodes, true, true, false},
        {"socialnode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"socialnode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"socialnode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"socialnode", "masternodedebug", &masternodedebug, true, true, false},
        {"socialnode", "startmasternode", &startmasternode, true, true, false},
        {"socialnode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"socialnode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"socialnode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"socialnode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"socialnode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"socialnode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"socialnode", "mnbudget", &mnbudget, true, true, false},
        {"socialnode", "preparebudget", &preparebudget, true, true, false},
        {"socialnode", "submitbudget", &submitbudget, true, true, false},
        {"socialnode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"socialnode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"socialnode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"socialnode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"socialnode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"socialnode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"socialnode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"socialnode", "checkbudgets", &checkbudgets, true, true, false},
        {"socialnode", "mnsync", &mnsync, true, true, false},
        {"socialnode", "spork", &spork, true, true, false},
        {"socialnode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"socialnode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use socialnoded, or the -server option to socialnode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> socialnode-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32302/\n";
}
