...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case SocialNode:
            return QString("SocialNode");
        case mSMN:
            return QString("Milli-SocialNode (1 / 1" THIN_SP_UTF8 "000)");
        case uSMN:
            return QString("Micro-SocialNode (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
