                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received SocialNode from zSMN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSMN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSMN));
