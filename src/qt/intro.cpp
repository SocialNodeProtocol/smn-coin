...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SocialNode Core"),
     ...
     * override -datadir in the socialnode.conf file in the default data directory
     * (to be consistent with socialnoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
