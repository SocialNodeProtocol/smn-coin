...
/** Utility functions used by the SocialNode Qt UI.
 */
namespace GUIUtil
{
...
// Render SocialNode addresses in monospace font
...
// Parse "socialnode:" URI into recipient object, return true on successful parsing
