                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SocialNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SocialNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and socialnode: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SocialNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about SocialNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SocialNode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SocialNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SocialNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a SocialNode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SocialNode Core help message to get a list with possible SocialNode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SocialNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SocialNode network", "", count));
}
...
{
    QString strTitle = tr("SocialNode Core"); // default title
...
/** Creates context menu, its actions, and socialnodes up all the relevant signals for mouse events. */
