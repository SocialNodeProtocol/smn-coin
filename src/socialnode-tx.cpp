...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SocialNode Core socialnode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  socialnode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded socialnode transaction") + "\n" +
                               "  socialnode-tx [options] -create [commands]   " + _("Create hex-encoded socialnode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded socialnode transaction
