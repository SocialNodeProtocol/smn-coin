...
void PrivateCoin::mintCoin(const CoinDenomination denomination) {
	// Repeat this process up to MAX_COINMINT_ATTSMNTS times until
	// we obtain a prime number
	for(uint32_t attempt = 0; attempt < MAX_COINMINT_ATTSMNTS; attempt++) {
	...
	// MAX_COINMINT_ATTSMNTS. Throw an exception.
