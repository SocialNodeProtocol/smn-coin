...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/socialnode-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/socialnode-cli.cpp \
           src/socialnode-tx.cpp \
           src/socialnode.cpp \
           src/db.cpp \
           ...
           src/qt/socialnode.cpp \
           src/qt/socialnodestrings.cpp \
...
RESOURCES += src/qt/socialnode.qrc src/qt/socialnode_locale.qrc

TRANSLATIONS += src/qt/locale/socialnode_bg.ts \
                src/qt/locale/socialnode_de.ts \
                src/qt/locale/socialnode_en.ts \
                src/qt/locale/socialnode_es.ts \
                src/qt/locale/socialnode_fi.ts \
                src/qt/locale/socialnode_fr.ts \
                src/qt/locale/socialnode_it.ts \
                src/qt/locale/socialnode_ja.ts \
                src/qt/locale/socialnode_pl.ts \
                src/qt/locale/socialnode_pt.ts \
                src/qt/locale/socialnode_ru.ts \
                src/qt/locale/socialnode_sk.ts \
                src/qt/locale/socialnode_sv.ts \
                src/qt/locale/socialnode_vi.ts \
                src/qt/locale/socialnode_zh_CN.ts \
                src/qt/locale/socialnode_zh_TW.ts
