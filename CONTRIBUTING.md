Contributing to SocialNode Core
============================

The SocialNode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SocialNode Core project, and is not to be
confused with overall SocialNode Network Protocol consensus changes.

Whether a pull request is merged into SocialNode Core rests with the project merge
...
Patches that change SocialNode consensus rules are considerably more involved than
...
Where a patch set proposes to change the SocialNode consensus, it must have been
...
The project leader is the release manager for each SocialNode Core release.
